<template>
  <div class="flex-col items-center">
    ...
    <p class="text-gray-600 text-xl text-center">
      Proyecto para obtener las cotizaciones de las critpomonedas mas
      importantes a traves de la API REST de Coincap.<br />Este proyecto es
      utilizado en el curso de Vue.js Basico de Platzi.
    </p>
